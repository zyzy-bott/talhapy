...
zyliex
    ...
    try:
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "yanlış yazdın. Tekrar dene.")
        sleep(3)
        continue
    if menu == 1:
        system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail adresi (Bilmiyosan 'enter' tuşuna bas): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
